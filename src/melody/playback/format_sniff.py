...
def ffmpeg_input_format(detected: str | None) -> str | None:
    """Formats safe to force for ffmpeg pipe input. OGG is excluded — it stalls on pipes."""
    if detected in ("mp3", "flac", "wav"):
        return detected
    return None
